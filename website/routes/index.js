  ...
  const buildGuideData = () => {
    ...
    const planMeta = {
      ...
      pro: {
        ...
        subtitle: "보안·이벤트·파트너·상점을 통합하는 최상위 단계",
        guideDescription: "Pro는 Discord 서버 운영에 필요한 모든 기능을 하나의 운영 플랫폼으로 통합하는 플랜입니다. 레이드 방지, 초대 링크 제어, 제재 관련 관리와 이벤트 기능에 더해 파트너 웹훅, 홍보 메시지 자동 전송 및 상단 배너 운영을 지원합니다. 또한 상점 임베드, 상품, 캐시 지급, 출석 보상과 생일 보상으로 유저 활동을 보상하고 커뮤니티 운영을 확장할 수 있습니다."
      }
    };
