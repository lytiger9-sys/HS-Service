...
export default {
  data: new SlashCommandBuilder().setName("닉네임랜덤").setDescription("봇과 관리자 외 멤버의 닉네임을 랜덤으로 변경합니다.").addBooleanOption((option) => option.setName("확인").setDescription("전체 닉네임 변경을 확인합니다.").setRequired(true)),
