...
export default {
  data: new SlashCommandBuilder().setName("nickinit").setDescription("봇과 관리자 외 모든 멤버의 닉네임을 기본 사용자명으로 복귀합니다.").addBooleanOption((option) => option.setName("확인").setDescription("전체 닉네임 초기화를 확인합니다.").setRequired(true)),
